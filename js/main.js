...
/*************************************************************************************
------------ ANSWER -------------------
these variables are not correct. because of hoisting the scopeThis() iffe runs the fuction which console.logs the x variable , which is undefined because of scope.  The x variable is declared outside the function.  If you were to change the variables where x = y & y=x, the code would work.
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
because of the way hoisting works, x would log undefined, while foo would return function hoisting. To fix this issue, you could declare the x variable directly under the warmUp function.
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
the console.log(add) within the function will return 4, while the one outside will be undefined. because of the iffe, the console will immediately run the function and return 4. Scope is also a factor in the second console.log returning undefined, as the console cannot find the const add inside the function.
**************************************************************************************/
